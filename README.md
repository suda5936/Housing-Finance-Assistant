...
필요 환경은 Node.js 22 이상, npm 10 이상, Python 3.12, Docker Desktop입니다.
...
웹은 `http://localhost:3000`, API 문서는 `http://localhost:8000/docs`, 상태 확인은 `http://localhost:8000/health`에서 확인합니다.
...
Phase 1 개발 기반이 마련된 상태입니다. 비즈니스 기능은 개발 로드맵의 순서대로 추가합니다.
